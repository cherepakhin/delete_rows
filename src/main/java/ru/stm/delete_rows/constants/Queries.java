...
public class Queries {
    ...
    public static final String CREATE_TABLE_BY_NAME = "create table %s (id SERIAL PRIMARY KEY, ddate timestamp )";
    ...
    public static final String CREATE_TEMP_TABLE_BY_SELECT = "create table temp_table as select * from %s where ddate > '%s'";
